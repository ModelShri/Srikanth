...
const Hero = () => {
  return (
    <section className="relative w-full h-screen mx-auto overflow-hidden bg-[#050816]">
      ...
      >
        ...
        <div className="pointer-events-auto">
          ...
          <div className="mt-4 flex flex-wrap gap-2 text-xs sm:text-sm font-medium">
            <span className="bg-tertiary/90 border border-white/10 px-3 py-1.5 rounded-lg text-white">
              6+ Yrs Exp
            </span>
            <span className="bg-tertiary/90 border border-white/10 px-3 py-1.5 rounded-lg text-white">
              10+ Modules HMIS
            </span>
            <span className="bg-tertiary/90 border border-white/10 px-3 py-1.5 rounded-lg text-emerald-400">
      ...
      {/* 3D Computer Canvas — fills entire hero section */}
